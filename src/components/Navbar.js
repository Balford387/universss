  ...
  return (
    <div className='flex justify-around bg-gray-300 mx-auto'>
        <h1 className='text-green-800 w-full font-bold text-center p-4 font-serif text-3xl'>TUNIVERSE</h1>
            ...
            <div className= {Nav ? 'fixed bg-gray-200 overflow-hidden left-0 top-0 w-[50%] h-full border-r border-r-gray-600 ease-in-out duration-500 lg:hidden': 'fixed left-[-100%] '}>
